    ...
    <div class="modal-content border-0 shadow">
      ...
      <form id="formNuevaPrenda" method="POST" action="/admin/prenda/crearPrenda" onsubmit="return false">
        <div class="modal-body">
          <div class="mb-3">
            <label for="Prenda_Partida_modal" class="form-label">Nombre de la prenda</label>
            <!-- NAME igual; ID distinto para no chocar -->
            <input type="text" class="form-control" id="Prenda_Partida_modal" name="Prenda_Partida" required>
          </div>
          <div class="mb-3">
            <label for="Partida_Partida_modal" class="form-label">Partida</label>
            <input type="text" class="form-control" id="Partida_Partida_modal" name="Partida_Partida" required>
          </div>
          <div class="mb-3">
            <label for="Composicion_Partida_modal" class="form-label">Composición</label>
            <input type="text" class="form-control" id="Composicion_Partida_modal" name="Composicion_Partida" required>
          </div>
